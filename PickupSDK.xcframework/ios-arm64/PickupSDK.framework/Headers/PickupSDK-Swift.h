...
#ifndef PICKUPSDK_SWIFT_H
#define PICKUPSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PickupSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


@class NSString;
@class PickupOrderResModel;
...
typedef SWIFT_ENUM(NSInteger, PUHTTPMethod, open) {
  PUHTTPMethodOptions = 0,
  PUHTTPMethodGet = 1,
  PUHTTPMethodHead = 2,
  PUHTTPMethodPost = 3,
  PUHTTPMethodPut = 4,
  PUHTTPMethodPatch = 5,
  PUHTTPMethodDelete = 6,
  PUHTTPMethodTrace = 7,
  PUHTTPMethodConnect = 8,
};


SWIFT_CLASS("_TtC9PickupSDK29PickupArrivalGeofenceResModel")
@interface PickupArrivalGeofenceResModel : NSObject
...
SWIFT_CLASS("_TtC9PickupSDK22PickupCustomerResModel")
@interface PickupCustomerResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9PickupSDK28PickupCustomerStatusResModel")
@interface PickupCustomerStatusResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9PickupSDK22PickupLocationResModel")
@interface PickupLocationResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9PickupSDK18PickupMetaResModel")
@interface PickupMetaResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9PickupSDK19PickupOrderResModel")
@interface PickupOrderResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9PickupSDK25PickupOrderStatusResModel")
@interface PickupOrderStatusResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9PickupSDK14PickupResModel")
@interface PickupResModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
